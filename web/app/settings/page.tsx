        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">
              {uiSettings.language === "hi" ? "सेटिंग्स" : "Settings"}
            </h1>
            <p className="text-sm text-slate-500 dark:text-slate-400">
              {uiSettings.language === "hi"
                ? "AI सेवाएं और प्राथमिकताएं कॉन्फ़िगर करें"
          ...
          <div className="flex flex-wrap items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
                ...
                <span>{uiSettings.language === "hi" ? "थीम" : "Theme"}</span>
              </div>
              <div className="flex p-1 bg-slate-100 dark:bg-slate-700 rounded-lg">
                ...
                >
                  ...
                  {uiSettings.language === "hi" ? "लाइट" : "Light"}
                </button>
                <button
                ...
                >
                  ...
                  {uiSettings.language === "hi" ? "डार्क" : "Dark"}
                </button>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
                ...
                <span>
                  {uiSettings.language === "hi" ? "भाषा" : "Language"}
                </span>
              </div>
              <div className="flex p-1 bg-slate-100 dark:bg-slate-700 rounded-lg">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
                ...
                <span>
                  {uiSettings.language === "hi" ? "स्थानीय डेटा" : "Local Data"}
                </span>
                {storageStats && (
              ...
              >
                {uiSettings.language === "hi" ? "कैश साफ़ करें" : "Clear Cache"}
              </button>
            </div>
          </div>
        </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 max-w-md mx-4 shadow-2xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">
                    {uiSettings.language === "hi" ? "हटाने की पुष्टि करें" : "Confirm Clear"}
                  </h3>
                  <p className="text-sm text-slate-500 dark:text-slate-400">
                    {uiSettings.language === "hi"
                      ? "यह सभी स्थानीय कैश डेटा हटा देगा"
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300 mb-6">
                {uiSettings.language === "hi"
                  ? "इसमें शामिल हैं: चैट इतिहास, सॉल्वर इतिहास, प्रश्न परिणाम, अनुसंधान रिपोर्ट, आइडिया जनरेशन, गाइडेड लर्निंग प्रगति, Co-Writer सामग्री आदि। यह कार्य पूर्ववत नहीं किया जा सकता।"
              ...
              <div className="flex justify-end gap-3">
                ...
                >
                  {uiSettings.language === "hi" ? "रद्द करें" : "Cancel"}
                </button>
                <button
                  onClick={() => {
                    clearAllPersistence();
                ...
                >
                  {uiSettings.language === "hi" ? "सब हटाएं" : "Clear All"}
                </button>
              </div>
            </div>
          </div>
