...
# =============================================================================
# Pydantic models for direct solve
# =============================================================================
...
# =============================================================================
# Direct Solve REST Endpoint (lightweight, reliable)
# =============================================================================


SOLVER_SYSTEM_PROMPT = """You are an expert mathematician, scientist, and technical problem solver. You solve problems with clear, detailed, step-by-step solutions.
...
- Set Theory: unions, intersections, complements, Venn diagrams, proofs
- Linear Algebra: eigenvalues, vector spaces, transformations
- Differential Equations: ODE, PDE, initial value problems
- Discrete Math: combinatorics, graph theory, number theory
- Physics & Engineering: formulas, unit analysis, circuit analysis
- Statistics & Probability: distributions, hypothesis testing, Bayes' theorem
- Any other mathematical or technical problem
...
- If there are multiple methods, show the most elegant one
- If the question is ambiguous, state your interpretation before solving

Always provide the complete solution. Never skip steps."""


@router.post("/solve/direct", response_model=DirectSolveResponse)
async def direct_solve(request: DirectSolveRequest):
    """
    Directly solve a math/technical problem using the LLM.
    This is a lightweight endpoint that bypasses the multi-agent pipeline.
    """
    ...
    full_prompt = history_context + request.question
    ...
    try:
        ...
        logger.info(f"Direct solve completed ({len(answer)} chars) for: {request.question[:80]}...")
        return DirectSolveResponse(answer=answer)
...
# =============================================================================
# WebSocket Endpoint for Solving (legacy multi-agent pipeline)
# =============================================================================
